    ...
    <body>
        ...
        <ul id="qm0" class="qmmc">
                ...
                <li><a class="qmparent" href="javascript:void(0)">Context</a>
                        ...
                        <ul>
                            <?php 
                                echo '<li><a href="HistorialView.php">ALL</a></li>';
                                foreach($contextList as $ct){
                                    echo '<li><a href="HistorialView.php?context='.$ct->getIdContexto().'">'.$ct->getNombreContexto().'</a></li>';
                                }
                            ?>
        ...
        <h1 id="logo">Getting Things Done!</h1>
            <div id="stuffBox">
                <div id="listaStuff">
                    <div id="listaTitulo">
                        <h2>History <?php echo $contextName==""? "" : " : ".$contextName; ?></h2>
<!--                        <a href="HistorialView.php?new=1">
                                            ...
                                            if(!in_array($st->getIdStuff(),$actConProj) && $st->getIdHistorial() != NULL && (!$contextIdSelected || $st->getIdContexto() == $contextIdSelected)){
                                                ...
                                                elseif (isset($newStuff) && $st->getNombre()=="Nuevo Stuff") {
                                                     echo '<li id="itemStuff" style="background-color: steelblue;color: aliceblue; border: 3px aliceblue solid;">'.$st->getNombre()."</li>";
                                                       ...
                                                       echo '<a href="HistorialView.php?idSt='.$st->getIdStuff().'">';
                ...
                <div id="detalleStuff">
                    ...
                    <form id='modifyStuff' action='HistorialView.php' method='post' accept-charset='UTF-8'>
                        <table>
                            <tr>
                                <td>
                                    <p>Name:</p>
                                ...
                                <td colspan="3">
                                    ...
                                    echo ($stuffName=="Selecciona Stuff" || $stuffName=="Nuevo Stuff")? "": $stuffName;?>" <?php echo 'readonly'?>>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <textarea name="stuffDescription" rows="3" cols="25" maxlength="255" readonly><?php  echo $stuffDescription; ?></textarea>
...
//                                    }  
                                ?>
                               <input type="submit"  name="restoreStuff" value="Restore" <?php echo $stuffSeleccionada? "" : "disabled"?>/>
                            </td>
                        </tr>
