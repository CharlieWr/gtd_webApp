...
//          $idDelete = $_POST['idStuffForm'];
    ...
    //Si hay algun stuff seleccionado
       if(isset($_GET['idSt'])){
           ...
           $vista = $stuffAssoc->getTypeStuff()? $stuffAssoc->getTypeStuff() : "";
    ...
    <body>
        ...
        <ul id="qm0" class="qmmc">
                ...
                <li><a class="qmparent" href="javascript:void(0)">Context</a>
                        ...
                        <ul>
                            <?php 
                                echo '<li><a href="ReviewView.php">ALL</a></li>';
                                foreach($contextList as $ct){
                                    echo '<li><a href="ReviewView.php?context='.$ct->getIdContexto().'">'.$ct->getNombreContexto().'</a></li>';
                                }
                            ?>
                ...
                <div id="listaStuff">
                    <div id="listaTitulo">
                        <form  style=" display: inline-block;"  >
                            <select  name="dropDownView" onchange="this.form.submit()" style=" display: inline-block; ">
                                <option value="" <?php echo $vista==""? "selected" : ""?>>Stuff</option>
                                <option value="N" <?php echo $vista=="N"? "selected" : ""?>>NextAction</option>
                                <option value="P" <?php echo $vista=="P"? "selected" : ""?>>Proyecto</option>
                                <option value="S" <?php echo $vista=="S"? "selected" : ""?>>Someday/Maybe</option>
                                <option value="W" <?php echo $vista=="W"? "selected" : ""?>>Waiting For</option>
                            </select>
                        </form>    
<!--                        <a href="ReviewView.php?new=1&dropDownView=<?php echo $vista;?>">
                            <p style="margin-left: 3.8em;"><strong>+</strong></p>
                        </a>-->
                        
<!--                        <h2><?php echo $vista;?></h2>-->
                                            ...
                                            if($st->getIdHistorial() == NULL && (!$contextIdSelected || $st->getIdContexto() == $contextIdSelected)){
                                                ...
                                                elseif (isset($newStuff) && $st->getNombre()=="Nuevo Stuff") {
                                                     echo '<li id="itemStuff" style="background-color: steelblue;color: aliceblue; border: 3px aliceblue solid;">'.$st->getNombre()."</li>";
                                                       ...
                                                       echo '<a href="ReviewView.php?idSt='.$st->getIdStuff().'">';
                ...
                <div id="detalleStuff">
                    ...
                    <form id='modifyStuff' action='ReviewView.php' method='post' accept-charset='UTF-8'>
                        <table>
                            <tr>
                                <td>
                                    <p>Name:</p>
                            ...
                            <tr>
                               ...
                               <td>
                               <input type="hidden" name="sendTo" value="<?php echo isset($stuffAssoc)? $stuffAssoc->getTypeStuff() : "";?>">
