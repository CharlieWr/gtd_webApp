<?php 
    ...
    $stuffName = "Select a Next Action";
    $stuffDescription = "";
      ...
      if(isset($_POST['saveStuff'])){
            ...
            redirect_to("NextActionView.php");
            ...
            <div id="stuffBox">
                <div id="listaStuff">
                    <div id="listaTitulo" style="height: 15.5%">
                        ...
                        <input type="checkbox" name="activaFilter" id="activaFilter" value="true"  style="margin-left: 20px;" onclick="cambiaFiltro();" <?php echo $filterActiva? "checked" : ""?>> Active
                        ...
                        <table>
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    echo ($stuffName=="Select a Next Action" || $stuffName=="Nuevo Stuff")? "": $stuffName;?>" <?php echo $stuffSeleccionada? "" : 'readonly'?>>
                                </td>
                                <td>
...
//                                
                                ?>
                               <input type="submit"  name="deleteStuff" onclick='return confirm("Are you sure you want to delete the selected Next Action?");' value="Delete" <?php echo $stuffSeleccionada? "" : "disabled"?>/>
                            </td>
                            <td colspan="3">
