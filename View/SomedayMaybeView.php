<?php 
    ...
    $stuffName = "Select a Someday/Maybe";
    $stuffDescription = "";
...
//          $idDelete = $_POST['idStuffForm'];
    ...
    //Si hay algun stuff seleccionado
       if(isset($_GET['idSt'])){
           ...
           $sm =  $smControl->getSMByStuffId($_GET['idSt']);
           $plazo = $sm->getPlazo();
        ...
        <div id="content">
          ...
          <a href="Home.php"><img src="images/todolist.png " /></a>
            ...
            <div id="stuffBox">
                <div id="listaStuff">
                    <div id="listaTitulo">
                        <h2>Someday/Maybes <?php echo $contextName==""? "" : " : ".$contextName; ?></h2>
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    ...
                                    echo ($stuffName=="Select a Someday/Maybe" || $stuffName=="Nuevo Stuff")? "": $stuffName;?>" <?php echo $stuffSeleccionada? "" : 'readonly'?>>
                                </td>
                                <td colspan="2"></td>
                                <td>
...
//                                
                                ?>
                               <input type="submit"  name="deleteStuff" onclick='return confirm("Are you sure you want to delete the selected Someday/Maybe?");' value="Delete" <?php echo $stuffSeleccionada? "" : "disabled"?>/>
                            </td>
                            <td colspan="3">
